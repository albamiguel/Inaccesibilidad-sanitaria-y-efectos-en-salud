...
group_by(`Comunidad autónoma`,`Sexo`,`Tipos atención sanitaria`)
  
View(Datos_filtrados_economicos)


Resultado2 <-
  drop_na() %>%
  ggplot(data = Datos_filtrados_economicos,
       mapping = aes(x =`Comunidad autónoma`, y = Total, fill=`Tipos atención sanitaria`)) +
  geom_bar(stat='identity',position='dodge')+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 60, vjust = 1, hjust=1))
  theme(axis.text.y = element_text(angle = 180, vjust = 1.5, hjust=1.5))
  labs(title= "Inaccesibilidad por motivos economicos", x= " ", y= " ")
  space(0.4,2.5)
Resultado2
...
Resultado3 <-
  ...
  theme_bw()+
  theme(axis.text.x = element_text(angle = 60, vjust = 1, hjust=1))+
  labs(title= "Inaccesibilidad transporte", x= " ", y= " ")
Resultado3
