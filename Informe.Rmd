...
library(readr)
Inaccesibilidad_y_dificultades_de_transporte_por_comunidad_autónoma_ <- read_csv("DATOS/Inaccesibilidad y dificultades de transporte (por comunidad autónoma).csv")
View(Inaccesibilidad_y_dificultades_de_transporte_por_comunidad_autónoma_)
